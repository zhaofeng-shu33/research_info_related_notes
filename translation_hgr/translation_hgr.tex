...
by a function $F(x)$,  the average quadratic deviation $Q$ is minimized, when the regression line $\bar{y}(x)$ is chosen as the fitting function for the distribution $w(x,y)$ of the observation points.
