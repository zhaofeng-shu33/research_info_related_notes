...
\begin{proof}
	...
	& = C_1\sum_{x\in \mathcal{X}} p_0^{\lambda}(x)p_1^{1-\lambda}(x)\log\frac{p_0^{\lambda}(x)p_1^{1-\lambda}(x)}{C_1 p_1(x)}  \\
	& + kC_2[p^{1-k\lambda}q^{k\lambda}\log\frac{p^{1-k\lambda}q^{k\lambda}}{C_2 p} +
	(1-p)^{1-k\lambda}(1-q)^{k\lambda}\log\frac{(1-p)^{1-k\lambda}(1-q)^{k\lambda}}{C_2(1-p)} ] 
	\end{align*}
