...
\begin{proof}
	...
	$P(\sum_{i=1}^{n} X_i - Z_i + 2\sum_{i=1}^{n/2} (X'_i - Z'_i) \geq 0) \leq n^{-\frac{3}{2} (\sqrt{a}-\sqrt{b})^2}$
	by Chernoff inequality. There are at most $n^3$ such terms. Therefore,
...
\begin{proof}
	...
	$P(A) \leq n^{-\gamma D_{1/2}(p_0||p_1)-(\sqrt{a}-\sqrt{b})^2}$. ($m=\gamma n$)
