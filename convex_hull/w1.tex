...
\end{equation}
Indeed, suppose $a=z^2-u^2, b=y^2-u^2, a<b$, we have
\begin{align}
...
Then
\begin{equation*}
(b-a)^{(d+1)/2}\int_0^{\sqrt{a/b}} [(1+t)^{d-1}-(1-t)^{d-1}] \frac{2t(a-bt^2)^{(d-5)/2}}{(1-t^2)^{d-1}}dt
\end{equation*}
