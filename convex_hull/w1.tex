...
\begin{align}\label{eq:H_general_simplification}
...
From \eqref{eq:H_general_simplification},
we have
\begin{align}
    H(x) & = \int_x^{+\infty}\frac{2x }{\pi \sqrt{y^2-x^2}}F_1(y)dy
\int_y^{+\infty} \sqrt{1-\frac{y^2}{z^2}}
|dF(z)| 
\end{align}
From Lemma \ref{lem:F_x_sqrt_11},
the inner integration is asymptotically
