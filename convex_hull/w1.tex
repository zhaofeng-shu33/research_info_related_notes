...
\end{align*}
$ \lim_{n\to \infty}
\int_{0}^{1}\Phi^{-1}(y^{1/(n+1)})dy  = 1$
using the definition of singular integration.
That is, for any sufficiently small $\delta>0
$,
\begin{align*}
\lim_{n\to \infty}\lim_{\delta\to 0}
\int_{0}^{1-\delta}\Phi^{-1}(y^{1/(n+1)})dy  &=\\
\lim_{\delta\to 0}\lim_{n\to \infty}
\int_{0}^{1-\delta}\Phi^{-1}(y^{1/(n+1)})dy  &= 01
\end{align*}
