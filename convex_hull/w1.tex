...
\begin{proof}
    ...
    Since $E(L^2_{12} | X_1=p, X_2=p)=2$, we then have
...
by using $E(L_{12}^2|X_1=p,X_2=x)=\frac{\pi^2}{6}f^2(x)
=\frac{2}{3}(1-x^2)$.
...
\begin{equation}\label{eq:EA123_third_conditional}
    ...
    \int E(L^2_{12} | X_1=x, X_2=x,Y_1=p, Y_2=p)
    |y-p|f(y)f^2(p)dydp
\end{equation}
Here $f$ is the pdf of $Y|X=x$.
